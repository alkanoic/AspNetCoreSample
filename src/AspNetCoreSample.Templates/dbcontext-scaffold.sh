dotnet ef dbcontext scaffold "Server=localhost;User=docker;Password=docker;Database=sample" Pomelo.EntityFrameworkCore.MySql -o Models --data-annotations -f
