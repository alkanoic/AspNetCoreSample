...
public sealed class MvcInProcessTest : IClassFixture<DbFixture>, IClassFixture<WebApplicationFactoryFixture<Program>>
{
    private readonly WebApplicationFactoryFixture<Program> _factory;

    public MvcInProcessTest(DbFixture db, WebApplicationFactoryFixture<Program> factory)
    {
        _factory = factory;
